      ...
      <td>
        <div className="flex items-center gap-2">
         ...
         { role === "admin" && (
          ...
          <FormModal table="lesson" type="delete" data={item} />
          </>
        )}
  ...
  return (
    <div className='bg-white p-4 rounded-md flex-1 m-4 mt-0'>
     ...
     <div className="flex items-center justify-between">
        <h1 className="hidden md:block text-lg font-semibold">Tout Les Lessons</h1>
      ...
      {/* LIST */}
      <Table columns={columns} renderRow={renderRaw} data={lessonsData}/>
