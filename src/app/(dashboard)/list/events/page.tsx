...
import { assignmentsData, classesData, eventsData, examsData, lessonsData, parentsData, resultsData, role, studentsData, subjectsData, teachersData } from "@/src/lib/data"
  ...
  const renderRaw = (item: Event) =>(
    <tr className="border-b border-gray-200 even:bg-green-50 text-sm hover:bg-brydelPurpleLight" key={item.id}>
      ...
      <td>
        ...
        <FormModal table="event" type="delete" data={item} />
        </>
        )}
  ...
  return (
    <div className='bg-white p-4 rounded-md flex-1 m-4 mt-0'>
     ...
     <div className="flex items-center justify-between">
        <h1 className="hidden md:block text-lg font-semibold">Tout Les Evenements</h1>
      ...
      {/* LIST */}
      <Table columns={columns} renderRow={renderRaw} data={eventsData}/>
